...
Based on the working minimal bot, extended with full features.
"""
...
async def cmd_about(message: types.Message):
    await message.answer("ℹ️ Бот создан для управления каналом и группой. Версия 3.0 (полностью рабочая)")
...
# ============================================
# MODERATION IN GROUP (only in the specified group)
# ============================================
@dp.message()
...
# ============================================
async def main():
    logger.info("🚀 Запуск полной версии бота (админ-команды работают)")
